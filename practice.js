// Country List with Country Code and Currency Code in the form of Object
const countryList = {
  AED: "AE",
  AFN: "AF",
  XCD: "AG",
...
// Adding the various country names to the option tag inside select tag.
for (let select of dropdowns) {
  for (let currCode in countryList) {
    // Creating new options inside select tag
    let newOption = document.createElement("option");
    newOption.innerText = currCode;
    newOption.value = currCode;
    // Making the default "from" = USD  and "to" = INR
